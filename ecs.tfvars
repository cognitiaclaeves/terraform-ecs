...
# Must be within the IP range of your VPC.
private_subnet_cidrs = ["10.10.50.0/24", "10.10.51.0/24"]
...
alb_name = "rearcquest-dev"

# TODO: Maybe name the cluster separately, rather than including the name of the cluster in $environment?